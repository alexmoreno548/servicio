...
class SponsorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post sponsors_url, params: { sponsor: { address: @sponsor.address, description: @sponsor.description, name: @sponsor.name } }
    end
  ...
  test "should update sponsor" do
    patch sponsor_url(@sponsor), params: { sponsor: { address: @sponsor.address, description: @sponsor.description, name: @sponsor.name } }
